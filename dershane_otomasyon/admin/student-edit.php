...
<head>
	...
	<title>Admin - Öğrenci Düzenle</title>
...
<!-- Page Content -->
    <div id="page-content-wrapper">
     ...
     <div class="container mt-5">
        ...
        <div class="mb-3">
          <label class="form-label">Veli Ad</label>
          <input type="text" 
                 class="form-control"
        ...
        <div class="mb-3">
          <label class="form-label">Veli Soyad</label>
          <input type="text" 
                 class="form-control"
     ...
     <form method="post"
              class="table-responsive shadow p-3 my-5 form-w" 
              action="req/student-change.php"
              id="change_password">
        <h3>Şifre Değiştir</h3><hr>
       ...
       <div class="mb-3">
          ...
          <div class="mb-3">
            <label class="form-label">Yeni Şifre Onayı</label>
                <input type="text" 
                       class="form-control"
                       name="c_new_pass"
                       id="passInput2"> 
